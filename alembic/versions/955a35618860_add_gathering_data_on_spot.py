...
def upgrade():
    ...
    op.execute('UPDATE spots SET gathering_data = true WHERE gathering_data IS NULL')
    op.alter_column('spots', 'gathering_data', nullable=False)
    op.create_index(op.f('ix_spots_gathering_data'), 'spots', ['gathering_data'], unique=False)
